...
import co.swapi.demo.ui.view.CharacterViewHolder

/**
 * Adapter for the list of Star Wars films.
 */
class CharactersAdapter : ListAdapter<People, androidx.recyclerview.widget.RecyclerView.ViewHolder>(PEOPLE_ENTITY_COMPARATOR) {
    ...
    override fun onBindViewHolder(holder: androidx.recyclerview.widget.RecyclerView.ViewHolder, position: Int) {
        ...
        if (data != null) {
            (holder as CharacterViewHolder).bind(data)
        }
    }
